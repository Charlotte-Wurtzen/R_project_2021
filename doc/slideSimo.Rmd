...
## Introduction
```{r tidyverse, echo = TRUE, out.width = "100%",  fig.height = 3}
include_graphics("/hex-tidyverse.png")
```
...
include_graphics("../results/07_histogram.png")
```
